...
export function getBookAuthorByIndex(index: number): [title: string, author: string] { // Tuple!
    const books = getAllBooks();
...
export function assertRefBookInstance(condition: any): asserts condition {
    if (!condition) {
        throw new Error('It is not an instace of RefBook');
    }
}
...
export function purge<T>(inventory: Array<T>): T[] { // T[] - we can use instead Array<T>
